      ...
      <div class="container mx-auto px-4 pt-5">
        <div class="flex items-center gap-3">
          ...
          >
            ...
            <div class="min-w-0 flex-1 grid grid-cols-1 grid-rows-2 items-center gap-y-0">
          ...
          <button
            type="button"
            class="btn btn-primary btn-circle h-10 min-h-10 w-10 self-center"
            onClick={togglePlay}
